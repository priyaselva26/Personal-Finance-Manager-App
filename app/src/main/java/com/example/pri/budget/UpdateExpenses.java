...
public class UpdateExpenses extends Activity implements View.OnClickListener {
//Declare UI elements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new DBhelper(UpdateExpenses.this);
    ...
    public void onClick(View v) {
        ...
        if (isValidnum2(Rs) && isValidWord(desc)) {
            ...
            Intent i = new Intent(UpdateExpenses.this, MainActivity.class); //redirecting another activity
            startActivity(i);
